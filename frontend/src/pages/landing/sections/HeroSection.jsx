  ...
  <header class="text-slate-700 relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 lg:mx-auto lg:flex-row lg:items-center">
    ...
    <nav aria-label="Header Navigation" class="peer-checked:pt-8 peer-checked:max-h-60 flex max-h-0 w-full flex-col items-center overflow-hidden transition-all lg:ml-24 lg:max-h-full lg:flex-row">
      <ul class="flex w-full flex-col items-center space-y-2 lg:flex-row lg:justify-center lg:space-y-0">
        <li class="lg:mr-12"><a class="rounded text-gray-700 transition focus:outline-none focus:ring-1 focus:ring-blue-700 focus:ring-offset-2" href="/admin">Dashboard</a></li>
        ...
        <li class="lg:mr-12"><a class="rounded text-gray-700 transition focus:outline-none focus:ring-1 focus:ring-blue-700 focus:ring-offset-2" href="#about">About Us</a></li>
        <li class="lg:mr-12"><a class="rounded text-gray-700 transition focus:outline-none focus:ring-1 focus:ring-blue-700 focus:ring-offset-2" href="#testimonials">Testimonials</a></li>
      </ul>
      ...
      <div class="my-4 flex items-center space-x-6 space-y-2 lg:my-0 lg:ml-auto lg:space-x-8 lg:space-y-0">
        ...
        <a href="/register" title="" class="whitespace-nowrap rounded-xl bg-blue-700 px-5 py-3 font-medium text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2 hover:bg-blue-600">Get Started</a>
      </div>
    </nav>
  </header>
  ...
  <div class="relative py-12 sm:py-16 lg:pt-20 xl:pb-0">
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-3xl text-center">
        ...
        <p class="mx-auto mt-12 max-w-md leading-7 text-gray-600"> Unlock the full potential of your students with ThriveTracker, the ultimate student performance tracking and prediction tool designed for educational institutes.</p>

        <div class="group relative mt-10 inline-flex">
          <a href="/register" title="" class="rounded-xl bg-blue-700 px-10 py-3 font-medium text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2 hover:bg-blue-600">Get Started now!</a>
    ...
    <div class="mt-16 mb-16 flex flex-col items-center justify-center divide-y divide-gray-300 sm:flex-row sm:divide-x sm:divide-y-0 md:mt-20">
      <div class="flex max-w-xs space-x-2 px-4 py-4">
        ...
        <p class="text-gray-600">Comprehensive Student Monitoring</p>
      </div>
      <div class="flex max-w-xs space-x-2 px-4 py-4">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
        </svg>
        <p class="text-gray-600">Predictive Analytics with ML Algorithms</p>
      </div>
      <div class="flex max-w-xs space-x-2 px-4 py-4">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
        <p class="text-gray-600">Personalized Interventions for every student</p>
      </div>
    </div>
  </div>
</div>
...
//     <>
//       <Navbar />
//       <div className="relative bg-white px-[250px] pb-[110px] pt-[120px] dark:bg-dark lg:pt-[150px]">
//         <div className="container">
//           <div className="-mx-4 flex flex-wrap">
//             <div className="w-full px-4 lg:w-5/12">
//               <div className="hero-content pt-[50px]">
//                 <h1 className="mb-5 text-4xl font-bold !leading-[1.208] text-dark dark:text-white sm:text-[42px] lg:text-[40px] xl:text-5xl">
//                 Empower Student Success with ThriveTracker.
//                 </h1>
//                 <p className="mb-8 max-w-[480px] text-base text-body-color dark:text-dark-6">
//                 Unlock the full potential of your students with ThriveTracker, the ultimate student performance tracking and prediction tool designed for educational institutes.
//                 </p>
...
//                     <SingleImage
//                       href="#"
//                       imgSrc="https://www.cmrit.ac.in/wp-content/uploads/2021/06/logo.png"
//                     />
...
//         <img src={imgSrc} alt="brand image" className="h-50 w-fit" />
//       </a>
//     </>
//   );
// };
...
//   return (
//     <header className={`absolute left-0 top-0 z-20 flex w-full items-center px-[250px]`}> 
//       <div className="container">
//         <div className="relative -mx-4 flex items-center justify-between ">
//           <div className="w-60 max-w-full px-4">
//             <a href="/#" className="block w-full py-5">
//               <img
//                 src="https://i.imgur.com/xuEYTgQ.png"
//                 alt="logo"
...
//                   <ListItem NavLink="/admin">Dashboard</ListItem>
