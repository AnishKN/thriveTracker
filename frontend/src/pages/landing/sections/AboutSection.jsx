          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            <div className="w-full px-4 lg:w-6/12">
              <div className="flex items-center -mx-3 sm:-mx-4">
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  ...
                  <div className="py-3 sm:py-4">
                    <img
                      src="https://images.pexels.com/photos/7567529/pexels-photo-7567529.jpeg"
                      alt=""
                      className="w-full rounded-2xl"
                    />
                  </div>
                ...
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className="relative z-10 my-4">
                    <img
                      src="https://images.pexels.com/photos/7567234/pexels-photo-7567234.jpeg"
                      alt=""
                      className="w-full rounded-2xl"
                    />
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                At ThriveTracker, we are dedicated to transforming student performance tracking and support for educational institutes. 
                Our mission is to empower educators with advanced data analytics, machine learning, and user-friendly technology to monitor, 
                understand, and support every student comprehensively.
                </p>
