...
//     <a href="#">
//         <img class="w-auto h-12" src="https://i.ibb.co/PtK7K0V/Frame-1-7.png" alt=""/>
...
//                     <span class="text-sm font-medium text-gray-700 dark:text-gray-200">Anish Krishna</span>
//                 </a>
...
<div className="flex h-screen flex-col justify-between border-e bg-white">
  ...
  {/* <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
    <a href="#" className="flex items-center gap-2 bg-white p-4 hover:bg-gray-50">
      ...
      <div>
        <p className="text-xs">
          <strong className="block font-medium">Anish Krishna</strong>

          <span> anish@cmrit.com </span>
        </p>
      </div>
    </a>
  </div> */}
